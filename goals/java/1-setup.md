...
You'll be building this challenge using the popular PetClinic demo repository from Spring. Clone it to an easy-to-access location on your machine.

#### PowerShell
```powershell
git clone https://github.com/spring-projects/spring-petclinic.git C:\github\spring-petclinic
```

#### Bash
```bash
git clone https://github.com/spring-projects/spring-petclinic.git ~/github/spring-petclinic
```

### Step 4: Initialize Spec-Kit in the PetClinic Repository

Navigate into the cloned repository and initialize Spec-Kit with the GitHub Copilot integration:

#### PowerShell
```powershell
cd C:\github\spring-petclinic
specify init --here --integration copilot
```

#### Bash
```bash
cd ~/github/spring-petclinic
specify init --here --integration copilot
```
...
Open the PetClinic project in VS Code or your preferred IDE.
...
### Step 7: Follow the README to Run PetClinic Locally

Follow the instructions in the `README.md` at the root of the PetClinic repository to set up the application locally. Ensure that you can:
...
[^2]: _VS Code supports all features. JetBrains IDEs require the workarounds noted through the workshop._
